            ...
            addContent: function () {
                $('body').on('click', '.metting-add', function () {
                    ...
                    var mettingHtml = "<div class='meeting new-metting'><div class='title'><input type='text' class='edit focus-input'  placeholder='会议主题' value=" + $mContent + "></div>"
                        ...
                        + "<div class='timeStart'><input type='text' class='edit focus-input datetimepicker1' value='' disabled placeholder='开始时间' onclick='$(this).datetimepicker({ datepicker: false, step: 5,format: &quot;H:i&quot})'>" 
                        + "</div><div>--</div>"
                        + "<div class='timeEnd'><input type='text' class='edit focus-input datetimepicker1' value='' disabled placeholder='结束时间' onclick='$(this).datetimepicker({ datepicker: false, step: 5,format: &quot;H:i&quot})'></div></div>"
